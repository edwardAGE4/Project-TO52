 ...
 */
@Entity
public class Conference extends Publication1  implements Serializable {
...
/*
    ...
    public Conference(String ConferenceName, Long Ranking, String Series, Long Pages, Long Volume, String Publisher, String Organization, String Editor, Integer idPublication, PublicationType publicationType, String englishTitle, String frenchTitle, Long year, Long month, String note, String linkImage, String pdfLink, String issn, String anAbstract, String keyWords,String  typrepublication) {
        super(idPublication, publicationType, englishTitle, frenchTitle, year, month, note, linkImage, pdfLink, issn, anAbstract, keyWords,typrepublication);
        this.ConferenceName = ConferenceName;
        this.Ranking = Ranking;
        this.Series = Series;
        this.Pages = Pages;
